 ...
 * @version $Id: Memcache.php 3 2011-12-29 15:01:09Z zjdboy $
 **/
class YC_Cache_Memcache extends YC {
    ...
    public function __construct() {
        ...
        @$this->mc->connect(isset($this->mccfg['host']) ? $this->mccfg['host'] : '127.0.0.1', isset($this->mccfg['port']) ? $this->mccfg['port'] : '11211') or self::showMsg('[MemCache:]Could not connect');
