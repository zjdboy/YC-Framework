 ...
 * @version $Id: Upload.php 3 2011-12-29 15:01:09Z zjdboy $
 **/
class YC_File_Upload {
    //--------------------
    public $fmsg = array();

    public $upfsize = 1048576;
    //允许上传文件大小小于等于1Mb
    public $upftype = 'gif|jpe|jpg|jpeg|png';
    //允许上传格式
    public $upfroot = NULL;
    //文件存放根路径
    public $upfsons = NULL;
    //文件存放子目录(<Y/m/d>)
    public $upfname = '<rand.5>';
    //文件名称-用于覆盖已存在的图片(<rand.5><ucid>)
