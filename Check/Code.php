 ...
 * @version $Id: Code.php 3 2011-12-29 15:01:09Z zjdboy $
 **/
class YC_Check_Code {

    public static $CodeMax = 4;
    //验证码长度
    public static $CodeStr = '__YC__code';
    ...
    public static function Index() {
        ...
        //header( "Content-Disposition:inline;filename=chackcode.png");
        imagepng($im);
        imagedestroy($im);
    }
