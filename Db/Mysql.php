 ...
 * @version $Id: Mysql.php 3 2011-12-29 15:01:09Z zjdboy $
 **/
class YC_Db_Mysql extends YC {
    ...
    public function getConn($r) {
        ...
        if (! isset($this->dbLink[$r])) {
            $this->dbLink[$r] = @mysql_connect($this->dbcfg[$r]['dbhost'], $this->dbcfg[$r]['dbuser'], $this->dbcfg[$r]['dbpwd']) or self::showMsg('Your Connection Failure ');
    ...
    public function showMsg($str) {
        if ($this->dbError) throw new YC_Exception($str . mysql_error());
    }
}
?>